...
public class AddNewGasStationActivity1 extends AppCompatActivity{
    ...
    protected void startTheCamera(){
        EasyImage.openCamera(AddNewGasStationActivity1.this, 1);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        EasyImage.handleActivityResult(requestCode, resultCode, data, this, new DefaultCallback() {
            ...
            public void onImagePicked(File imageFile, EasyImage.ImageSource source, int type) {
                ...
                Glide.with(AddNewGasStationActivity1.this).load(imageFile).centerCrop().into(headerPhoto);
            }
            ...
            public void onCanceled(EasyImage.ImageSource source, int type) {
                ...
                if (source == EasyImage.ImageSource.CAMERA) {
                    File photoFile = EasyImage.lastlyTakenButCanceledPhoto(AddNewGasStationActivity1.this);
